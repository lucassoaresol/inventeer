...
- **Confirm after the gate passes** - Resolve Discuss within Specify, require `validate_spec.py` to exit clean, then present the complete review package for approval before writing canonical artifacts or moving to Design
