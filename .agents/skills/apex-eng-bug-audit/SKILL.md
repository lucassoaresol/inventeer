...
description: "APEX · Engineering Workflow to Audit Quality Bugs and Gaps Wrapper gerado: lê e executa apex://framework/workflows/eng-bug-audit. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-bug-audit`.
