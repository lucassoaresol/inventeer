---
name: apex-eng-docs
description: "APEX · Documentation (engineering) Wrapper gerado: lê e executa apex://framework/workflows/eng-docs. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-docs`.
