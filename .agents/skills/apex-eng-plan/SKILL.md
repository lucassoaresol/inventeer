---
name: apex-eng-plan
description: "APEX · Phased execution planning for a feature Wrapper experimental: inspeciona apex://framework/workflows/eng-plan no Codex; não use como executor de entrega."
---

# APEX · eng-plan

Phased execution planning for a feature
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/eng-plan` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
