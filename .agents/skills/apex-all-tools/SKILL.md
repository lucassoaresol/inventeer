---
name: apex-all-tools
description: "APEX · Summary of all workflows and tools Wrapper experimental: inspeciona apex://framework/workflows/all-tools no Codex; não use como executor de entrega."
---

# APEX · all-tools

Summary of all workflows and tools
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/all-tools` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
