---
name: apex-eng-debug
description: "APEX · Engineering workflow for debugging and incidents Wrapper experimental: inspeciona apex://framework/workflows/eng-debug no Codex; não use como executor de entrega."
---

# APEX · eng-debug

Engineering workflow for debugging and incidents
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/eng-debug` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
