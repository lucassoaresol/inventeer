---
name: apex-eng-debug
description: "APEX · Engineering workflow for debugging and incidents Wrapper gerado: lê e executa apex://framework/workflows/eng-debug. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-debug`.
