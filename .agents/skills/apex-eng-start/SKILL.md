---
name: apex-eng-start
description: "APEX · Initiates planning for a task by creating the architecture.md Wrapper gerado: lê e executa apex://framework/workflows/eng-start. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-start`.
