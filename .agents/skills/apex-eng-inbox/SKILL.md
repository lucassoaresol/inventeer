---
name: apex-eng-inbox
description: "APEX · Validate and route Requirements Packs into the delivery pipeline Wrapper experimental: inspeciona apex://framework/workflows/eng-inbox no Codex; não use como executor de entrega."
---

# APEX · eng-inbox

Validate and route Requirements Packs into the delivery pipeline
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/eng-inbox` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
