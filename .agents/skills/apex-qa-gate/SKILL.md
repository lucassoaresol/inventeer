---
name: apex-qa-gate
description: "APEX · Run quality gate validation for a technical specification Wrapper experimental: inspeciona apex://framework/workflows/qa-gate no Codex; não use como executor de entrega."
---

# APEX · qa-gate

Run quality gate validation for a technical specification
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/qa-gate` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
