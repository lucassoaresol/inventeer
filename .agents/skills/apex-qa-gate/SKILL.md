---
name: apex-qa-gate
description: "APEX · Run quality gate validation for a technical specification Wrapper gerado: lê e executa apex://framework/workflows/qa-gate. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/qa-gate`.
