---
name: apex-eng-pr
description: "APEX · Branch creation, commit and pull request (PR) Wrapper gerado: lê e executa apex://framework/workflows/eng-pr. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-pr`.
