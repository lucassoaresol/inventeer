---
name: apex-eng-light-arch
description: "APEX · Lightweight architectural design Wrapper experimental: inspeciona apex://framework/workflows/eng-light-arch no Codex; não use como executor de entrega."
---
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/eng-light-arch` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
