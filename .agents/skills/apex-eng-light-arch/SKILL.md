...
description: "APEX · Lightweight architectural design Wrapper gerado: lê e executa apex://framework/workflows/eng-light-arch. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-light-arch`.
