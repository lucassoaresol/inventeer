# Linear Context for Inventeer Assistants

Read this reference when resolving or validating an Assistants issue hierarchy.
...
The permanent product navigation issue for Assistants is `INV-2228`.
...
4. Stop successfully only when the chain reaches `INV-2228`.
...
- Parent identifier and project association.
...
- the chain does not reach `INV-2228`;
