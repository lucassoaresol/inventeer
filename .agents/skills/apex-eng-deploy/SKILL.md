...
description: "APEX · Deploy and operate a release — environment promotion, gradual rollout, health verification, and rollback on regression. Wrapper gerado: lê e executa apex://framework/workflows/eng-deploy. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-deploy`.
