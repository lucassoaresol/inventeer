...
description: "APEX · Quality gate validation workflow for Tech Specs Wrapper experimental: inspeciona apex://framework/workflows/qa-quality-gate-validation no Codex; não use como executor de entrega."
---
...
1. Use este wrapper somente quando o usuário pedir inspeção ou diagnóstico explícito da integração
   APEX no Codex.
2. Leia o recurso MCP `apex://framework/workflows/qa-quality-gate-validation` e pare se o servidor, recurso ou conteúdo não estiver
   disponível.
