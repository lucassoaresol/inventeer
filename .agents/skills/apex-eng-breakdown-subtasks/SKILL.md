...
description: "APEX · Workflow to break down Tech Spec into ULTRA DETAILED and executable subtasks Wrapper gerado: lê e executa apex://framework/workflows/eng-breakdown-subtasks. Requer o servidor MCP apex."
---
...
1. Leia o recurso MCP `apex://framework/workflows/eng-breakdown-subtasks`.
